...
/**
 * @generated from protobuf message service.products.v1.ProductServiceCreateProductRequest
 */
...
/**
 * @generated from protobuf message service.products.v1.ProductServiceAllProductsRequest
 */
...
/**
 * @generated from protobuf message service.products.v1.ProductServiceAllProductsResponse
 */
export interface ProductServiceAllProductsResponse {
    /**
     * @generated from protobuf field: repeated service.products.v1.Product products = 1;
     */
    products: Product[];
}
...
class ProductServiceCreateProductRequest$Type extends MessageType<ProductServiceCreateProductRequest> {
    constructor() {
        super("service.products.v1.ProductServiceCreateProductRequest", [
...
/**
 * @generated MessageType for protobuf message service.products.v1.ProductServiceCreateProductRequest
 */
...
class ProductServiceAllProductsRequest$Type extends MessageType<ProductServiceAllProductsRequest> {
    constructor() {
        super("service.products.v1.ProductServiceAllProductsRequest", [
...
/**
 * @generated MessageType for protobuf message service.products.v1.ProductServiceAllProductsRequest
 */
...
class ProductServiceAllProductsResponse$Type extends MessageType<ProductServiceAllProductsResponse> {
    constructor() {
        super("service.products.v1.ProductServiceAllProductsResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ProductServiceAllProductsResponse): ProductServiceAllProductsResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated service.products.v1.Product products */ 1:
    ...
    internalBinaryWrite(message: ProductServiceAllProductsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated service.products.v1.Product products = 1; */
...
/**
 * @generated MessageType for protobuf message service.products.v1.ProductServiceAllProductsResponse
 */
